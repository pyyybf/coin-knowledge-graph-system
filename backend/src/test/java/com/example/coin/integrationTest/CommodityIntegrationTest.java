...
import com.example.coin.controller.commodity.CommodityController;
...
public class CommodityIntegrationTest {
    ...
    public void testGetAllCommodities() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                .get("/api/commodity/getAllCommodities")
    ...
    @Test
    public void testGetCommentByCommodityId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                .get("/api/commodity/getCommentByCommodityId")
                .accept(MediaType.APPLICATION_JSON_UTF8_VALUE)
                .param("commodityId","2"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
